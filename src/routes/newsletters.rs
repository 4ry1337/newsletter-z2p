...
pub async fn publish_newsletter(
    ...
    for subscriber in subscribers {
        match subscriber {
            ...
            Err(error) => {
                tracing::warn!(error.error_chain = ?error, "Skipping a confirmed subscriber. Their stored contact details are invalid");
            }
        }
    }
...
async fn validate_credentials(
    ...
    .fetch_optional(pool)
    .await
    .context("Failed to perform a query to validate authorization credentials.")
